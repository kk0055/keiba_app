...
class Entry(models.Model):
    ...
    finish_rank = models.IntegerField("着順", null=True, blank=True)
    ...
    finish_time = models.CharField("タイム", max_length=20, null=True, blank=True)
    prize_money = models.BigIntegerField("賞金(円)", null=True, blank=True)
    ...
    class Meta:
        ...
        ordering = ["race__race_date", "umaban"]  # レース日、馬番で並ぶように
